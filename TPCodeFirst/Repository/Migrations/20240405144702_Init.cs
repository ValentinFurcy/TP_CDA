        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price_KM = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nb_KM = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Clients",
                columns: new[] { "Id", "DateNaissance", "FirstName", "LastName" },
                values: new object[,]
                {
                    { 1, new DateOnly(1990, 10, 20), "Durand", "Olivier" },
                    { 2, new DateOnly(1993, 12, 2), "Dupond", "Nathan" },
                    { 3, new DateOnly(1988, 10, 20), "Croft", "Lara" }
                });
